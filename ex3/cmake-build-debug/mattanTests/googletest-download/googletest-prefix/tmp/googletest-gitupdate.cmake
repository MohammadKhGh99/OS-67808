...
# yet).
execute_process(
  COMMAND "/cygdrive/c/Program Files/Git/cmd/git.exe" rev-list --max-count=1 "${git_tag}"
  WORKING_DIRECTORY "/cygdrive/c/Users/m7mdg/Documents/Studies/Year 3/Semester b/67808 Operating Systems/ex3/cmake-build-debug/mattanTests/googletest-src"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      execute_process(
        COMMAND "/cygdrive/c/Program Files/Git/cmd/git.exe" checkout "${git_remote}/${git_tag}"
        WORKING_DIRECTORY "/cygdrive/c/Users/m7mdg/Documents/Studies/Year 3/Semester b/67808 Operating Systems/ex3/cmake-build-debug/mattanTests/googletest-src"
        RESULT_VARIABLE error_code
        )
      if(error_code)
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/cygdrive/c/Users/m7mdg/Documents/Studies/Year 3/Semester b/67808 Operating Systems/ex3/cmake-build-debug/mattanTests/googletest-src'."
        ...
        execute_process(
          COMMAND "/cygdrive/c/Program Files/Git/cmd/git.exe" tag -a
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/cygdrive/c/Users/m7mdg/Documents/Studies/Year 3/Semester b/67808 Operating Systems/ex3/cmake-build-debug/mattanTests/googletest-src'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
    ...
    execute_process(
      COMMAND "/cygdrive/c/Program Files/Git/cmd/git.exe" checkout "${git_tag}"
      WORKING_DIRECTORY "/cygdrive/c/Users/m7mdg/Documents/Studies/Year 3/Semester b/67808 Operating Systems/ex3/cmake-build-debug/mattanTests/googletest-src"
      RESULT_VARIABLE error_code
      )
    if(error_code)
